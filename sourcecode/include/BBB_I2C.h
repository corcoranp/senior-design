...
public:
	...
	void writeMoreBits(uint8_t DATA_REGADD, uint8_t data, uint8_t length, uint8_t startBit);
	void writeByte(uint8_t DATA_REGADD, uint8_t data); //writeRegister
	...
	uint8_t readBit(uint8_t DATA_REGADD, uint8_t bitNum);   //readRegister...
